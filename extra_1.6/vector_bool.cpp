...
Vector<bool>::const_iterator Vector<bool>::begin(){
  Vector<bool>::const_iterator ci;
  ci.distance = 0;
  return ci; 
} 


Vector<bool>::const_iterator Vector<bool>::end(){
  Vector<bool>::const_iterator ci;
  return ci; 
} 


bool operator<(Vector<bool>::const_iterator v1,Vector<bool>::const_iterator v2){
  return v1.distance < v2.distance;
}

bool operator<(Vector<bool>::const_iterator v1,int n){
  return v1.distance < n;
}
